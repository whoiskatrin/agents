import { Agent, createAddressBasedResolver, routeAgentEmail, routeAgentRequest, } from "agents";
...
export class EmailAgent extends Agent {
    ...
    async sendAutoReply(originalEmail) {
        try {
...
export const email = async (email, env) => {
